...
public class ReservationService {
    ...
    public Reservation updateReservation(long id, Reservation reservationToUpdate) {
        if (reservationToUpdate.id() != id) {
            throw new IllegalArgumentException("id in path should be equal to id in request body");
        }
    ...
    public Reservation approveReservation(long id) {
        ...
        reservationRepository.canceledConflictPendingReservationWithCurrentApproveReservation(reservation.roomId(),
                approvedReservation.getEndDate(),
                approvedReservation.getStartDate()
        );
...
//                if (reservationToCanceled.roomId() == mapReservationEntityToDomainReservation(approvedReservation).roomId()) {
//                    if (
...
//        }
    ...
    private boolean isReservationConflict(Reservation reservation) {
        return reservationRepository.existsConflictReservationsForRoomAndDate(reservation.roomId(),
                reservation.startDate(),
                reservation.endDate()) == true;
